...
export const FRONTEND_PORT = Number(process.env.FRONTEND_PORT) || Number(portsConfig.frontend);
export const BACKEND_PORT = Number(process.env.PORT) || Number(process.env.BACKEND_PORT) || Number(portsConfig.backend);
